...
/*********************************************************
  ...
  Summary:
    Calculate the PIC32 SPI Baud Rate Generator (BRG) value
  Conditions:
    None
  Input:
...
// we do not use hardward Card Detect for microSD cards, RS 2011-02-02
    SD_CS = 1;                     //Initialize Chip Select line
    SD_CS_TRIS = OUTPUT;            //Card Select - output
//    SD_WE_TRIS = INPUT;            //Write Protect - input
// we do not use hardware Write Enable for microSD cards, RS 2011-02-02
}
...
{
//    return(SD_WE);
    return(0); // for microSD cards, always assume not write protected, RS 2011-02-01
}
